...
public class UserMessageController {
    ...
    @GetMapping("/session/getOrCreate")
    public FwResult<MessageChatSessionVo> getOrCreateSession(
            @RequestParam Integer productId,
            @RequestParam Integer otherUserId) {

        return FwResult.ok(messagesService.getOrCreateSession(productId, otherUserId));
    }
